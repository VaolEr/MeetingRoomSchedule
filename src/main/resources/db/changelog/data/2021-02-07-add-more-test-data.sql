...
VALUES ('2021-06-28', (SELECT id FROM events WHERE name = 'JohnDoe Monday event'),'2021-06-28 12:15:00','2021-06-28 12:45:00',(SELECT id FROM meetingrooms WHERE name = 'Test Room')),
       ('2021-06-28', (SELECT id FROM events WHERE name = 'Admin Monday event'),'2021-06-28 08:00:00','2021-06-28 08:45:00',(SELECT id FROM meetingrooms WHERE name = 'Test Room')),
       ('2021-06-28', (SELECT id FROM events WHERE name = 'User Monday event'),'2021-06-28 13:30:00','2021-06-28 18:30:00',(SELECT id FROM meetingrooms WHERE name = 'Test Room'));
