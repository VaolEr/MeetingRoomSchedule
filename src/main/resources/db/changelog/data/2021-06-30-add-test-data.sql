...
VALUES ('2021-06-30', (SELECT id FROM events WHERE name = 'JohnDoe First event'),'2021-06-30 12:15:00','2021-06-30 12:45:00',(SELECT id FROM meetingrooms WHERE name = 'Test Room')),
       ...
       ('2021-06-30', (SELECT id FROM events WHERE name = 'Admin First event'),'2021-06-30 08:00:00','2021-06-30 08:45:00',(SELECT id FROM meetingrooms WHERE name = 'Test Room')),
       ('2021-06-30', (SELECT id FROM events WHERE name = 'Admin Second event'),'2021-07-01 11:15:00','2021-07-01 11:45:00',(SELECT id FROM meetingrooms WHERE name = 'Test Room')),
       ...
       ('2021-06-30', (SELECT id FROM events WHERE name = 'Admin Fourth event'),'2021-07-01 12:50:00','2021-07-01 13:20:00',(SELECT id FROM meetingrooms WHERE name = 'Test Room')),
       ('2021-06-30', (SELECT id FROM events WHERE name = 'User First event'),'2021-07-01 13:30:00','2021-07-02 13:30:00',(SELECT id FROM meetingrooms WHERE name = 'Test Room')),
